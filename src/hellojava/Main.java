...
public class Main {
	...
	public static void main(String[] args) {
		...
		// String
		// filepath="/Users/i079889/Documents/workspace/ASEDOJO/src/hello/Main.java";
		// System.out.println("Code lines of current file is
		// "+getCodeLinesOfSource(filepath));
		// filepath="/Users/i079889/Documents/workspace/ASEDOJO/src/hello/whitespaceandcommentstest.java";
		// System.out.println("Code lines of "+"whitespaceandcommentstest.java is
		// "+getCodeLinesOfSource(filepath));
		// filepath="/Users/i079889/Documents/workspace/ASEDOJO/src/hello/Emptyfiletest.java";
		// System.out.println("Code lines of "+"Emptyfiletest.java is
		// "+getCodeLinesOfSource(filepath));
		//
		// File path = new
		// File("/Users/i079889/git/gradle-aafsystem-module/src/main/java/com/successfactors/aaf/tests/system/odata");
		// search(path);
		//
		// System.out.println(count+" java files so far!");
		int[] testarr = { 1, 3, 5, 7, 9 };
		MoveP test = new MoveP();
		test.movePelements(testarr, 3);
		int i = 0;
	...
	private static void search(File path) {
		...
		if (path.getAbsolutePath().equalsIgnoreCase(
				"/Users/i079889/git/gradle-aafsystem-module/src/main/java/com/successfactors/aaf/tests/system/odata")) {
